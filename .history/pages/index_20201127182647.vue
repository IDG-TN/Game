...
export default {
  ...
  methods: {
    ...
    posiGoRefs(val) {
      console.log(val);
      console.log(this.$refs.val.getBoundingClientRect().top);
      switch (val) {
        case 0:
          console.log(this.$refs.newGames.getBoundingClientRect().top);
          break;
        case 1:
          console.log(this.$refs.FEATUREO.getBoundingClientRect().top);
          break;
        case 2:
          console.log(this.$refs.HotGames.getBoundingClientRect().top);
          break;
      ...
      //   .scrollTo(this.$refs.val.getBoundingClientRect().top);
      // console.log(document.querySelector(".section").offsetHeight);
    }
  }
};
</script>
...
.footer {
  ...
  background: #111111;
  overflow: hidden;
  margin: 0.3rem 0 -0.14rem -0.14rem;
  p {
    font-size: 0.12rem;
    text-align: center;
    margin: 0.04rem 0;
