<template>
  <div class="game-carrier">
    ...
    <iframe id="some_frame_id" :src="src" scrolling="no" height="100%"></iframe>
  </div>
</template>
...
export default {
  ...
  mounted() {
    ...
    document.querySelector("#some_frame_id").style.height = hashH / 100 + "rem";
    document.querySelector(".game-carrier").style.height = hashH / 100 + "rem";
    document.querySelector(".game-carrier").style.overflow = 'hidden'
  },
  methods: {
    popupAddevenet() {
