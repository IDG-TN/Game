...
export default {
  ...
  created() {
    ...
    this.getTrandecodeUrl(true);
    this.getTrandecodeUrl(false);
    // this.pageGame = {
    //   newGame: sortData.splice(0, 9),
    //   hotGame: hotData.splice(0, 9),
    //   featGame: featGame
    // };
  },
  components: {
