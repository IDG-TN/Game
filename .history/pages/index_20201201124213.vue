...
export default {
  ...
  created() {
    var test = "[{'name':'zhangsan'}]";
    console.log(test);
    console.log(eval("(" + test + ")"));

    if (this.pageList != "") {
      var copyPage = JSON.parse(JSON.stringify(this.pageList));
      console.log(eval("(+"copyPage "+""])"));
    }
  },
  mounted() {
    // console.log(this.pageList)
    // let data = JSON.parse(JSON.stringify(this.pageList));
    // console.log(data);
    // // console.log(eval("(" + data + ")"));
    // console.log(JSON.parse(data))
    // var obj = eval("(" + this.pageList + ")");
    // console.log(obj);
    // this.pageGameList = this.pageList;
  },
  data() {
    return {
      //页面数据
