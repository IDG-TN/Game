...
export default {
  created() {
    ...
    // var datas = [{ name: "zhangsan" }];
    // console.log(typeof datas); // array

    // console.log(JSON.parse(JSON.stringify(data))[0].name);
    this.$axios.get("/list").then(res => {
      // this.pageGameList = res.data;
      let data = eval("(" + data + ")"); res.data;
