<template>
  <div class="game-carrier">
    ...
    <iframe
      id="some_frame_id"
      src="https://html5.gamedistribution.com/1ac03aed33eb4f55a885dfaab4e97a50/"
      frameborder="0"
      width="800px"
      height="600px"
      scrolling="no"
...
export default {
  ...
  methods: {
    ...
    reloadGamePage() {
        let ifname = document.querySelector('')
        console.log(document.all.document)
    //   window.open(document.all.ifrmname.src, "some_frame_id", "");
    }
  }
};
</script>
