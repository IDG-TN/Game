<template>
  <div class="container">
    ...
    <div class="section">
      ...
      <h2 class="newGames">
        <p>
          <img src="../static/images/youxi_1.png" alt="">
        </p>
        
        <p><span class="fy">New Games</span>
        <span @click="goHome('/page')">more</span></p> 
      </h2>
    ...
    posiGoRefs(val) {
      switch (val) {
        case 0:
          ...
          break;
        case 1:
          document.querySelector(".feat").scrollIntoView({
            behavior: "smooth", //定义动画过渡效果"auto"或 "smooth" 之一。默认为 "auto"。
            block: "start",
            inline: "nearest"
          });
          break;
        case 2:
          document.querySelector(".HotGames").scrollIntoView({
            behavior: "smooth", //定义动画过渡效果"auto"或 "smooth" 之一。默认为 "auto"。
            block: "start",
            inline: "nearest",
            top: -40
