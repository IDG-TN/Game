...
export default {
  ...
  methods: {
    getMoveGameList(val) {
      ...
      document.querySelector('.container').scrollIntoView(document.querySelector('.container'))
      // this.$set(this.cData, val,0);
      // let classifyData = this.conData.filter((item, index) => {
      ...
      //     conData: JSON.stringify(this.conData)
      //   }
      // });
      // this.$router.go(0);
    },
