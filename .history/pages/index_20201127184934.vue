    ...
    posiGoRefs(val) {
      switch (val) {
        case 0:
          ...
          document.documentElement.scrollTo(0, num - 50);
          console.log(num);
          break;
        case 1:
          let num1;
          num1 = this.$refs.feat.getBoundingClientRect().top;
          console.log(num1);
          if (num1 < 0) {
            document.documentElement.scrollTo(0, 0);
            num1 = this.$refs.feat.scrollTop();
          }
          document.documentElement.scrollTo(0, num1 - 50);
          break;
        case 2:
          let num2;
          num2 = this.$refs.HotGames.getBoundingClientRect().top;
          console.log(num2);
          if (num < 2) {
            document.documentElement.scrollTo(0, 0);
            num2 = this.$refs.HotGames.getBoundingClientRect().top;
          }
          document.documentElement.scrollTo(0, num2 - 50);
