...
export default {
  async asyncData({ $axios }) {
    const { data } = await $axios.get("https://api.dptest.dtgh91.com/topic/getTopicList?is_hot=1&page=1&pageNum=10&token=a273m9JqjSuumFaNNenFKXmYOD4dHbl3wpFjTGtW9WPugd1smm%2FIRtMkxN1%2F3Du6O5O3KfIR");
