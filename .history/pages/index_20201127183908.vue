    ...
    posiGoRefs(val) {
      ...
      switch (val) {
        case 0:
          ...
          console.log(num);
          document.querySelector(".container").scrollTo(num, num);
          break;
        case 1:
          num = this.$refs.feat.getBoundingClientRect().top;
          document.querySelector(".container").scrollTo(0, num);
          break;
        case 2:
          num = this.$refs.HotGames.getBoundingClientRect().top;
          document.querySelector(".section").scrollTo(0, 1000);
          console.log(num);
          break;
        default:
          break;
